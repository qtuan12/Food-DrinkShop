                        ...
                        <div class="table-wrapper" style="border-style: solid; border-width: 1px">
                            <div class="table-title" style="background: #202831">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <a href="addAccount.jsp"  class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Add New Account</span></a>
                                ...
                                <tbody>
                                    <c:forEach items="${listA}" var="o">
                                        <tr>
                                            ...
                                            <td>${o.isAdmin}</td>
                                            <td>
                                                <a href="loadAccount?aid=${o.id}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                                <a href="deleteAccount?aid=${o.id}" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
