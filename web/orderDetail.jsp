                ...
                <div class="container">
                    <div class="table-wrapper" style="border-style: solid; border-width: 1px">
                        <div class="table-title" style="background: #202831">
                            <div class="row">
                                <div class="col-sm-6">
                                    <a href="order?aid=${sessionScope.acc.id}" class="edit" style="color:white; text-decoration: none">Back</a>
                                <h2>Your Order</h2>
                            ...
                            <c:forEach items="${listOD}" var="o"> 
                                <c:set var="t" value="${t+1}"></c:set>
                                    ...
                                    <td>
                                        <c:forEach items="${listF}" var="f">
                                            <c:if test="${o.fid == f.id}">
                                                <a href="detail?fid=${f.id}" class="edit"><i class="fas fa-info-circle"></i></a>
                                                </c:if>
                                            </c:forEach>
                                    </td>
                                </c:forEach>
