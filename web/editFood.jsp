                            ...
                            <form action="editFood" method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="quantity" type="text" class="form-control" value="${detail.quantity}" required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="modal-footer">
                                    <a href="managerFood"><input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel"></a>
